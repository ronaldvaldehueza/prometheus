...
const ActionBarF02: React.FC<ActionBarF02Props> = ({ handleFilter, value, handlePerPage, rowsPerPage, domRefToSave, pageOrientation, destinationFile }) => {
