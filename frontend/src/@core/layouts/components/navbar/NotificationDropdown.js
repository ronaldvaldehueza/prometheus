...
const NotificationDropdown = () => {
  ...
  const notificationsArray = [
    ...
    },
    {
      avatarContent: 'MD',
      color: 'light-danger',
      subtitle: 'Medical Philippines order updated',
      title: (
        <p className='media-heading'>
    ...
    },
    {
      ...
      color: 'light-danger',
      subtitle: 'Amazon Server is down due to hight CPU usage',
      title: (
        <p className='media-heading'>
    ...
    },
    {
      ...
      color: 'light-warning',
      subtitle: 'HO Server using high memory',
      title: (
        <p className='media-heading'>
  ...
  return (
    <UncontrolledDropdown tag='li' className='dropdown-notification nav-item me-25'>
      <DropdownToggle tag='a' className='nav-link' href='/' onClick={e => e.preventDefault()}>
        <Bell size={21} color='currentColor'/>
